...
window.set_font(None, 12)

player = character.hero(100,100, 50, 50, window.SCREEN_WIDTH/2, window.SCREEN_HEIGHT/2, (255, 0, 0))
...
def main(args):
    while True:
        ...
        try:
            ...
            window.write("Window Template", (window.SCREEN_WIDTH - 40, window.SCREEN_HEIGHT - 8), (0, 0, 0)) 
